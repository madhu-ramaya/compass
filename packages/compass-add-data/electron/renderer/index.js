...
import CompassAddDataPlugin, { activate } from '../../src/index.js';
...
const url = process.env.COMPASS_ADD_DATA_DEV_MONGODB_URL || 'mongodb://localhost:27017';
const namespace = process.env.COMPASS_ADD_DATA_DEV_NAMESPACE || 'test.test';
